        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="text-xl font-bold text-blue-400">
              AIToolKit<span className="text-gray-400">.space</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tools?category=text" className="text-gray-400 hover:text-white transition-colors">
                  Text Generation
                </Link>
              </li>
              <li>
                <Link href="/tools?category=image" className="text-gray-400 hover:text-white transition-colors">
                  Image Creation
                </Link>
              </li>
              <li>
                <Link href="/tools?category=audio" className="text-gray-400 hover:text-white transition-colors">
                  Audio Processing
                </Link>
              </li>
              <li>
                <Link href="/tools?category=video" className="text-gray-400 hover:text-white transition-colors">
                  Video Editing
                </Link>
              </li>
            </ul>
